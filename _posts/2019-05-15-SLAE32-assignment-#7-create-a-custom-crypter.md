...
<img style="display: block;margin-left: auto;margin-right: auto;border: 2px solid black;" src="{{ site.baseurl }}/assets/images/2019/05/1png-1.png" alt="" />
...
<img style="display: block;margin-left: auto;margin-right: auto;border: 2px solid black;" src="{{ site.baseurl }}/assets/images/2019/05/2png.png" alt="" />

where a is the modular multiplicative inverse of '**a**'' modulo m i.e., it satisfies the equation&nbsp;

<img style="display: block;margin-left: auto;margin-right: auto;border: 2px solid black;"" src="{{ site.baseurl }}/assets/images/2019/05/3.png" alt="" />
