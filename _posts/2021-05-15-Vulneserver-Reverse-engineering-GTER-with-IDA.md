...
<p align="justify">
As we see at the assembly code above, some values are placed on the stack in order to be placed at the <code><b>strncmp</b></code> function as arguments later. One interesting instruction we see on IDA is the <code><b>call near ptr unk_402Db8</b></code>. This instruction specifies a near call to a relative address of the next instruction that as we see below it contains a jmp instruction to an offset which points to <code><b>strncmp</b></code> function. 
</p>
